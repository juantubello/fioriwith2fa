		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori ",
									"targetURL": "#fioricapfioriwithcapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioricapfioriwithcapp-display": {
								"semanticObject": "fioricapfioriwithcapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiori.cap.fioriwithcapp",
									"url": sap.ui.require.toUrl("fiori/cap/fioriwithcapp")
								}
							}
						}
					}
